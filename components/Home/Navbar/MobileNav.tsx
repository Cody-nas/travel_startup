...
const MobileNav = ({ closeNav, showNav }: Props) => {
  ...
  return (
    <div>
      ...
      {/* navlinks */}
      <div
        className={`textwhite ${navOpen} fixed justify-center flex flex-col h-full transform transition-all duration-500 delay-300 w-[60%] bg-rose-900 space-y-6 z-[1050]`}
      >
        {navLinks.map((link) => {
          return (
